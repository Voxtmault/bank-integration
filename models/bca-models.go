...
type Amount struct {
	...
	Currency string `json:"currency" validate:"required,max=3"` // Currency code (e.g., IDR)
}
...
type VAPaymentStatusRequest struct {
	...
	CustomerNo       string      `json:"customerNo" validate:"required,number,max=18"`                                        // Unique customer number
	...
	InquiryRequestId string      `json:"inquiryRequestId" validate:"required,min=30,max=30"`                                  // Unique identifier from inquiry / bill presentment (generated by BCA)
	PaymentRequestId string      `json:"paymentRequestId" validate:"required,min=30,max=30"`                                  // Unique identified from payment (generated by BCA). This value must be the same as inquiryRequestId
